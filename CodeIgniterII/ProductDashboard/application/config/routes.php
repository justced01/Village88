...
$route['edit/validate'] = 'users/process_edit_profile';

$route['logout'] = 'users/logout';

$route['dashboard'] = 'dashboard';

$route['products/new/validate'] = 'products/process_product';
$route['products/edit/(:any)'] = 'products/edit/$1';
$route['products/edit/validate/(:any)'] = 'products/process_edit_product/$1';
